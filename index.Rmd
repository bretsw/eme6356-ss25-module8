...
[bretsw.com/eme6356-ss25-module8](https://bretsw.com/eme6356-ss25-module8)
...
# `r fa("fas fa-arrows-turn-to-dots", fill = "#fff")` Continue Learning
...
# `r fa("fas fa-arrows-turn-to-dots", fill = "#fff")` GitHub Copilot

```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
include_graphics("img/copilot.png")
```
